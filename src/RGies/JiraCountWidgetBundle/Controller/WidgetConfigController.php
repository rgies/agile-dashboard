 ...
 *
 * @Route("/jira_count_widget_widgetconfig")
 */
class WidgetConfigController extends Controller
{
     ...
     *
     * @Route("/", name="JiraCountWidgetBundle_widgetconfig_create")
     * @Method("POST")
     * @Template("JiraCountWidgetBundle:WidgetConfig:new.html.twig")
     */
    ...
    private function createCreateForm(WidgetConfig $entity)
    {
        $form = $this->createForm(new WidgetConfigType($this->container), $entity, array(
            'action' => $this->generateUrl('JiraCountWidgetBundle_widgetconfig_create'),
            'method' => 'POST',
     ...
     *
     * @Route("/new/{id}", name="JiraCountWidgetBundle_widgetconfig_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="JiraCountWidgetBundle_widgetconfig_edit")
     * @Method("GET")
     * @Template()
     */
    public function editAction($id)
    {
        ...
        if (!$items) {
            return $this->forward('JiraCountWidgetBundle:WidgetConfig:new', array('id' => $id));
        }
    ...
    {
        $form = $this->createForm(new WidgetConfigType($this->container), $entity, array(
            'action' => $this->generateUrl('JiraCountWidgetBundle_widgetconfig_update', array('id' => $entity->getId())),
            'method' => 'PUT',
     ...
     *
     * @Route("/{id}", name="JiraCountWidgetBundle_widgetconfig_update")
     * @Method("PUT")
     * @Template("JiraCountWidgetBundle:WidgetConfig:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        $em = $this->getDoctrine()->getManager();

        $entity = $em->getRepository('JiraCountWidgetBundle:WidgetConfig')->find($id);
