...
namespace RGies\JiraCountWidgetBundle\Entity;
 ...
 * WidgetConfig
 *
 * @ORM\Table(name="JiraCountWidgetConfig")
 * @ORM\Entity(repositoryClass="RGies\JiraCountWidgetBundle\Entity\WidgetConfigRepository")
 */
class WidgetConfig
{
    /**
