...
namespace RGies\JiraEstimatesWidgetBundle\Entity;
 ...
 * WidgetConfig
 *
 * @ORM\Table(name="JiraEstimatesWidgetConfig")
 * @ORM\Entity(repositoryClass="RGies\JiraEstimatesWidgetBundle\Entity\WidgetConfigRepository")
 */
class WidgetConfig
{
    /**
