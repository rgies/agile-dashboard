...
namespace RGies\MetricsBundle\Command;
...
use RGies\MetricsBundle\Generator\BundleGenerator;
...
class GenerateBundleCommand extends GeneratorCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Generates a new dashboard widget')
            ->setHelp(<<<EOT
The <info>dashboard:generate:widget</info> command helps you generates new dashboard widget.
...
<info>php app/console dashboard:generate:widget --namespace=MyName/MyWidgetBundle</info>
...
<info>php app/console dashboard:generate:widget --namespace=MyName/MyWidgetBundle --dir=src [--bundle-name=...] --no-interaction</info>

Note that the bundle namespace must end with "Bundle".
EOT
            )
            ->setName('dashboard:generate:widget')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $templateDir = str_replace('\\',
            '/',
            realpath(__DIR__ . '/../Resources/skeleton/widget')
        );
    ...
    {
        $questionHelper = $this->getQuestionHelper();
        $questionHelper->writeSection($output, 'Welcome to the Dashboard widget generator');
        ...
        if (null === $namespace) {
            $output->writeln(array(
                ...
                '',
                'Each bundle is hosted under a namespace (like <comment>MyName/MyWidgetBundle</comment>).',
                'The namespace should begin with a "vendor" name like your company name, your',
                'project name, or your client name, followed by one or more optional category',
                'sub-namespaces, and it should end with the bundle name itself',
                '(which must have <comment>WidgetBundle</comment> as a suffix).',
                '',
