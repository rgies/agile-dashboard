...
use RGies\JiraSpendTimeWidgetBundle\Entity\WidgetConfig;
use RGies\JiraSpendTimeWidgetBundle\Form\WidgetConfigType;
...
class WidgetConfigController extends Controller
{
     ...
     *
     * @Route("/", name="JiraSpendTimeWidgetBundle_widgetconfig_create")
     * @Method("POST")
     * @Template("JiraSpendTimeWidgetBundle:WidgetConfig:new.html.twig")
     */
    ...
    private function createCreateForm(WidgetConfig $entity)
    {
        $form = $this->createForm(new WidgetConfigType($this->container), $entity, array(
            'action' => $this->generateUrl('JiraSpendTimeWidgetBundle_widgetconfig_create'),
            'method' => 'POST',
     ...
     *
     * @Route("/new/{id}", name="JiraSpendTimeWidgetBundle_widgetconfig_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="JiraSpendTimeWidgetBundle_widgetconfig_edit")
     * @Method("GET")
     * @Template()
     */
    public function editAction($id)
    {
        ...
        if (!$items) {
            return $this->forward('JiraSpendTimeWidgetBundle:WidgetConfig:new', array('id' => $id));
        }
    ...
    {
        $form = $this->createForm(new WidgetConfigType($this->container), $entity, array(
            'action' => $this->generateUrl('JiraSpendTimeWidgetBundle_widgetconfig_update', array('id' => $entity->getId())),
            'method' => 'PUT',
     ...
     *
     * @Route("/{id}", name="JiraSpendTimeWidgetBundle_widgetconfig_update")
     * @Method("PUT")
     * @Template("JiraSpendTimeWidgetBundle:WidgetConfig:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        $em = $this->getDoctrine()->getManager();

        $entity = $em->getRepository('JiraSpendTimeWidgetBundle:WidgetConfig')->find($id);
        ...
        if ($editForm->isValid()) {
            $em->flush();
            $this->get('CacheService')->deleteValue('JiraSpendTimeWidget', $entity->getWidgetId());
